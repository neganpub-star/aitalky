...
import com.aitalky.framework.ratelimit.RateLimitProperties;
import com.aitalky.framework.translate.TranslateProperties;
 ...
 */
@Configuration
@EnableConfigurationProperties({JwtProperties.class, VerifyCodeProperties.class, RsaProperties.class, MinioProperties.class, GeoIpProperties.class, TranslateProperties.class, RateLimitProperties.class})
