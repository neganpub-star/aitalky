-- Flyway V1: 初始化全量表结构
-- 由当前库 mysqldump --no-data 重生(折叠原 V1-V41 的全部 DDL 变更),排除 flyway_schema_history。
-- 重基线说明:旧库已重基线到 V2(删历史表 + baseline-version=2),本脚本仅用于全新部署。
...
CREATE TABLE `bil_project_resource` (
  ...
  `used_amount` bigint NOT NULL DEFAULT '0' COMMENT '已消耗量(translate_char/ai_tokens 累计;customer 走实时计数不用)',
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` bigint DEFAULT NULL COMMENT '更新者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
...
CREATE TABLE `cnv_conversation` (
  ...
  `translate_to` varchar(16) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '客户消息翻译目标语言(aitalky 语言码 zh_CN/en_US...);空=未设',
  `agent_auto_translate` tinyint NOT NULL DEFAULT '0' COMMENT '坐席消息是否自动翻成客户语言发出(B方向开关)',
  ...
  `last_sys_type` varchar(16) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '最后消息系统语义码(assigned/unassigned/timeout;普通消息NULL)',
  ...
  `agent_read_seq` bigint NOT NULL DEFAULT '0' COMMENT '坐席已读到的最大 seq(信使端据此显示客户消息未读/已读)',
  PRIMARY KEY (`id`),
...
CREATE TABLE `wiki_article` (
  ...
  `project_id` bigint NOT NULL COMMENT '项目ID',
  `code` varchar(16) DEFAULT NULL COMMENT '文章短码(对外展示的文章ID,base62)',
  ...
  `share_code` varchar(32) DEFAULT NULL COMMENT '外链分享码(已发布生成)',
  `create_by` bigint DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `update_by` bigint DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  ...
  KEY `idx_project` (`project_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='wiki文章';
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `wiki_article_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `wiki_article_history` (
  ...
  `snapshot` longtext COMMENT '内容快照(JSON,各语言 title/summary/content)',
  `operator_id` bigint DEFAULT NULL COMMENT '操作人成员ID',
  `create_by` bigint DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `update_by` bigint DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='wiki文章历史记录';
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `wiki_article_i18n`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `wiki_article_i18n` (
  ...
  `title` varchar(255) DEFAULT NULL COMMENT '文章名(草稿)',
  `summary` varchar(512) DEFAULT NULL COMMENT '文章描述(草稿)',
  `content` longtext COMMENT '文章正文(草稿,Markdown/HTML)',
  `pub_title` varchar(255) DEFAULT NULL COMMENT '文章名(已发布快照)',
  `pub_summary` varchar(512) DEFAULT NULL COMMENT '文章描述(已发布快照)',
  `pub_content` longtext COMMENT '文章正文(已发布快照)',
  ...
  KEY `idx_project` (`project_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='wiki文章多语言内容';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wiki_category` (
  ...
  `icon` varchar(64) DEFAULT NULL COMMENT '类别图标(图标库key)',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='wiki类别';
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `wiki_category_article`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `wiki_category_article` (
  ...
  KEY `idx_project` (`project_id`),
  KEY `idx_article` (`article_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='wiki类别-文章关联(物理删除)';
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `wiki_category_i18n`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `wiki_category_i18n` (
  ...
  `category_id` bigint NOT NULL COMMENT '类别ID',
  `lang` varchar(16) NOT NULL COMMENT '语言',
  `name` varchar(128) DEFAULT NULL COMMENT '类别名(分语言)',
  `description` varchar(512) DEFAULT NULL COMMENT '类别描述(分语言)',
  `create_by` bigint DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `update_by` bigint DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  ...
  KEY `idx_project` (`project_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='wiki类别多语言名';
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `wiki_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='wiki分组(类别下)';
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `wiki_group_i18n`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `wiki_group_i18n` (
  ...
  `lang` varchar(16) NOT NULL COMMENT '语言',
  `name` varchar(128) DEFAULT NULL COMMENT '分组名(分语言)',
  `create_by` bigint DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `update_by` bigint DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  ...
  KEY `idx_project` (`project_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='wiki分组多语言名';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wiki_site` (
  `id` bigint NOT NULL COMMENT '主键(雪花)',
  `project_id` bigint NOT NULL COMMENT '项目ID',
  `share_code` varchar(16) DEFAULT NULL COMMENT '站点对外公开标识(base62);预览/分享/对外站点路由用',
  `icon` varchar(64) DEFAULT NULL COMMENT '应用图标(图标库key)',
  `logo` varchar(512) DEFAULT NULL COMMENT '应用LOGO(站点全局,非分语言)',
  `brand_short` varchar(64) DEFAULT NULL COMMENT '产品简称(站点全局)',
  `default_lang` varchar(16) NOT NULL DEFAULT 'zh_CN' COMMENT '默认语言',
  `multi_lang` tinyint NOT NULL DEFAULT '0' COMMENT '是否多语言:0单语 1多语',
  `theme_color` varchar(16) DEFAULT NULL COMMENT '主题色(hex)',
  `layout` tinyint NOT NULL DEFAULT '1' COMMENT '类别页布局:1列表模式 2双栏模式',
  `subdomain` varchar(64) DEFAULT NULL COMMENT '子域(项目内唯一,对外站点用)',
  `custom_domain` varchar(128) DEFAULT NULL COMMENT '自定义域名(对外站点用)',
  `favicon` varchar(512) DEFAULT NULL COMMENT '站点 favicon',
  ...
  UNIQUE KEY `uk_site_share_code` (`share_code`),
  KEY `idx_project` (`project_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='wiki站点(应用)';
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `wiki_site_i18n`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `wiki_site_i18n` (
  ...
  `lang` varchar(16) NOT NULL COMMENT '语言',
  `app_name` varchar(128) DEFAULT NULL COMMENT '应用名称(分语言)',
  `title` varchar(255) DEFAULT NULL COMMENT '站点首页标题(宣传文案)',
  `description` varchar(512) DEFAULT NULL COMMENT '自定义描述文字',
  `create_by` bigint DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `update_by` bigint DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  ...
  KEY `idx_project` (`project_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='wiki站点多语言文案';
/*!40101 SET character_set_client = @saved_cs_client */;
